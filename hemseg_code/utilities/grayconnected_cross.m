function bw = grayconnected_cross(I, r, c, tolerance)  %#codegen
...
value = I(double(r(1)), double(c(1)));
minWindow = value - double(tolerance(1));
maxWindow = value + double(tolerance(1));

similarValuesImage = (I >= minWindow) & (I <= maxWindow);
bw = bwselect(similarValuesImage, c, r, 4);
end
